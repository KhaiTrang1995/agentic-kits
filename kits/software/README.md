...
|-----|--------|--------|--------------------|
| [drawio-kit](https://github.com/KhaiTrang1995/agentic-awesome-kits/tree/main/kits/software/drawio-kit) | Available | Architecture & technical diagrams (`.drawio` / diagrams.net) | `/architecture`, `/flowchart`, `/erd`, `/diagram` — brain: `DRAWIO-BRAIN.md` |
